<div align="center">
  ...
  <p>
    ...
    <a href="https://agentdure.com">AgentDure</a>
  </p>
</div>
...
### [AgentDure](https://agentdure.com)

AgentDure is an AI workspace where you build an agent once and call it from anywhere. Author prompts and agents as versioned projects, then serve them through the console, an OpenAI-compatible API, Slack, or webhooks. Its agent loop handles multi-turn tool use with turn budgets, on-demand skills, and subagent transfers, backed by MCP tool integration, live traces, and per-call cost tracking with spending limits.
